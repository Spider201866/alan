...
- Read README.md and VERIFICATION.md before running or changing the harness.
...
- Do not publish runs, work/, credentials, personal settings or unrelated files. A publication request must be explicit.
- Release numbers are version 1 for harness components and v0.2.0 for Alan. Keep exact input checksums in PROVENANCE.json and run manifests.
